...
public class Toninho extends AppCompatActivity {

    private static final String TAG = "Toninho";

    private ListView mToninhoListView;
    private JogadoresFirebaseAdapter mToninhoFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mToninhoDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToninhoDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("torcedores").child("Toninho");

        // Inicializa as referências das Views
        mToninhoListView = (ListView) findViewById(R.id.toninhoDadosListView);


        // Initialize toninhoListView and its adapter, o ArrayList é a fonte de dados do ToninhoFirebaseAdapter
        //pelo objeto mToninhoFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mToninhoFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mToninhoListView.setAdapter(mToninhoFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Toninho
                JogadoresFirebase toninhoFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mToninhoFirebaseAdapter.add(toninhoFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mToninhoDatabaseReference.addChildEventListener(mChildEventListener);
    }
