...
public class GabrielActivity extends AppCompatActivity {
    ...
    private ListView mGabrielListView;
    private JogadoresFirebaseAdapter mGabrielFirebaseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGabrielDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("meioCampo").child("Gabriel");

        // Inicializa as referências das Views
        mGabrielListView = (ListView) findViewById(R.id.gabrielDadosListView);
        ...
        mGabrielFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mGabrielListView.setAdapter(mGabrielFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                JogadoresFirebase gabrielFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mGabrielFirebaseAdapter.add(gabrielFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
