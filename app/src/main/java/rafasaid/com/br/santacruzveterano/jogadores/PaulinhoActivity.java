...
public class PaulinhoActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Paulinho";

    private ListView mPaulinhoListView;
    private JogadoresFirebaseAdapter mPaulinhoFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mPaulinhoDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPaulinhoDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("zagueiros").child("Paulinho");

        // Inicializa as referências das Views
        mPaulinhoListView = (ListView) findViewById(R.id.paulinhoDadosListView);


        // Initialize paulinhoListView and its adapter, o ArrayList é a fonte de dados do PaulinhoFirebaseAdapter
        //pelo objeto mPaulinhoFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mPaulinhoFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mPaulinhoListView.setAdapter(mPaulinhoFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Paulinho
                JogadoresFirebase paulinhoFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mPaulinhoFirebaseAdapter.add(paulinhoFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mPaulinhoDatabaseReference.addChildEventListener(mChildEventListener);
    }
