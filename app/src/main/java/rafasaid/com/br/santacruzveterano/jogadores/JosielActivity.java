...
public class JosielActivity extends AppCompatActivity {

    private static final String TAG = "Josiel";

    private ListView mJosielListView;
    private JogadoresFirebaseAdapter mJosielFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mJosielDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mJosielDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("atacantes").child("Ziel");

        // Inicializa as referências das Views
        mJosielListView = (ListView) findViewById(R.id.josielDadosListView);


        // Initialize josielListView and its adapter, o ArrayList é a fonte de dados do JosielFirebaseAdapter
        //pelo objeto mJosielFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mJosielFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mJosielListView.setAdapter(mJosielFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Josiel
                JogadoresFirebase josielFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mJosielFirebaseAdapter.add(josielFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mJosielDatabaseReference.addChildEventListener(mChildEventListener);
    }
