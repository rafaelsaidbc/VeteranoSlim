...
public class RomarioActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Romario";

    private ListView mRomarioListView;
    private JogadoresFirebaseAdapter mRomarioFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mRomarioDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRomarioDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("goleiros").child("Romario");

        // Inicializa as referências das Views
        mRomarioListView = (ListView) findViewById(R.id.romarioDadosListView);


        // Initialize romarioListView and its adapter, o ArrayList é a fonte de dados do RomarioFirebaseAdapter
        //pelo objeto mRomarioFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mRomarioFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mRomarioListView.setAdapter(mRomarioFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Romario
                JogadoresFirebase romarioFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mRomarioFirebaseAdapter.add(romarioFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mRomarioDatabaseReference.addChildEventListener(mChildEventListener);
    }
