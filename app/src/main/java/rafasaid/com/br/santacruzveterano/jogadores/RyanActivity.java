...
public class RyanActivity extends AppCompatActivity {
    ...
    private ListView mRyanListView;
    private JogadoresFirebaseAdapter mRyanFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mRyanDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRyanDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("atacantes").child("Ryan");

        // Inicializa as referências das Views
        mRyanListView = (ListView) findViewById(R.id.ryanDadosListView);


        // Initialize ryanListView and its adapter, o ArrayList é a fonte de dados do RyanFirebaseAdapter
        //pelo objeto mRyanFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mRyanFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mRyanListView.setAdapter(mRyanFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Ryan
                JogadoresFirebase ryanFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mRyanFirebaseAdapter.add(ryanFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mRyanDatabaseReference.addChildEventListener(mChildEventListener);
    }
