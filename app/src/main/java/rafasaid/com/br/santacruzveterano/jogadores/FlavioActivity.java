...
public class FlavioActivity extends AppCompatActivity {

    private static final String TAG = "Flavio";

    private ListView mFlavioListView;
    private JogadoresFirebaseAdapter mFlavioFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mFlavioDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFlavioDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("zagueiros").child("Flavio");

        // Inicializa as referências das Views
        mFlavioListView = (ListView) findViewById(R.id.flavioDadosListView);


        // Initialize flavioListView and its adapter, o ArrayList é a fonte de dados do FlavioFirebaseAdapter
        //pelo objeto mFlavioFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mFlavioFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mFlavioListView.setAdapter(mFlavioFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Flavio
                JogadoresFirebase flavioFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mFlavioFirebaseAdapter.add(flavioFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mFlavioDatabaseReference.addChildEventListener(mChildEventListener);
    }
