...
public class AlissonActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Alisson";

    private ListView mAlissonListView;
    private JogadoresFirebaseAdapter mAlissonFirebaseAdapter;

    // Firebase instance variables
    private FirebaseDatabase mFirebaseDatabase;//ponto de acesso do app ao Database
    private DatabaseReference mAlissonDatabaseReference;//classe que faz referência a uma parte específica da Database;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAlissonDatabaseReference = mFirebaseDatabase.getReference().child("jogadores").child("meioCampo").child("Alisson");

        // Inicializa as referências das Views
        mAlissonListView = (ListView) findViewById(R.id.alissonDadosListView);


        // Initialize alissonListView and its adapter, o ArrayList é a fonte de dados do AlissonFirebaseAdapter
        //pelo objeto mAlissonFirebaseAdapter
        List<JogadoresFirebase> jogadoresFirebase = new ArrayList<>();
        mAlissonFirebaseAdapter = new JogadoresFirebaseAdapter(this, R.layout.jogadores_firebase, jogadoresFirebase);
        mAlissonListView.setAdapter(mAlissonFirebaseAdapter);
        ...
        mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                //obtêm os dados de Alisson
                JogadoresFirebase alissonFirebase = dataSnapshot.getValue(JogadoresFirebase.class);//desserializa o resultado do banco de dados para o objeto ResultadoFirebase
                //o objeto ResultadoFirebase deve ter os mesmos campos dos objetos de resultado do banco de dados


                mAlissonFirebaseAdapter.add(alissonFirebase);//adiciona o objeto ResultadoFirebase ao Adapter, converte
        ...
        mAlissonDatabaseReference.addChildEventListener(mChildEventListener);
    }
